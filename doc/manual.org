...
#+language:             en
#+macro:                version 0.5.0
#+macro:                release-date 2023-02-28
#+texinfo_filename:     darkman.info
#+texinfo_dir_title:    Seamless integration between Darkman and Emacs using the D-Bus protocol.
#+latex_class:          article
...
This manual is a reference guide for Darkman {{{version}}}, first
